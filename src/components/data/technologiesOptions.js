    ...
    tecnologias: [
      {
        name: "HTML",
        icon: (
          <IconBrandHtml5 className="w-20 h-20 celular:w-16 celular:h-16" />
        ),
      },
      {
        name: "CSS",
        icon: <IconBrandCss3 className="w-20 h-20 celular:w-16 celular:h-16" />,
      },
      {
        name: "JavaScript",
        icon: (
  ...
  },
  {
    ...
    tecnologias: [
      ...
      },
      {
        name: "Tailwind CSS",
        icon: (
          <IconBrandTailwind className="w-20 h-20 celular:w-16 celular:h-16" />
        ),
      },
      {
        name: "React",
        icon: (
          <IconBrandReact className="w-20 h-20 celular:w-16 celular:h-16" />
        ),
      },
      {
        name: "Astro",
    ...
    tecnologias: [
      {
        name: "MySQL",
        icon: (
          <IconBrandMysql className="w-20 h-20 celular:w-16 celular:h-16" />
        ),
      },
      {
        name: "NoSQL",
        icon: <IconCoins className="w-20 h-20 celular:w-16 celular:h-16" />,
      },
      {
        name: "Node.js",
        icon: (
          <IconBrandNodejs className="w-20 h-20 celular:w-16 celular:h-16" />
        ),
      },
      {
        name: "MongoDB",
      ...
      },
      {
        ...
        icon: (
          <svg
            ...
            id="Express--Streamline-Simple-Icons"
            className="w-20 h-20 celular:w-16 celular:h-16"
          >
